...
export const completeDelivery = async (req:Request,res:Response) =>{
    ...
    res.json({order:updatedOrder,message:"Delivered completed successfully"})
}
export const cancelDelivery = async (req:Request,res:Response) =>{
    ...
    history.push({status:'Cancelled',note:"", timestamp:new Date()})
...
export const updateDeliveryStatus = async (req:Request , res: Response) =>{
    ...
    history.push({status:"Cancelled",note:`Status updated to ${status}`, timestamp: new Date()})
...
export const updateLocation = async(req:Request,res:Response) =>{
    ...
    await prisma.order.update({
        where:{id:order!.id},
        data:{liveLocation:{lat,lng,updatesAt:new Date()}}
    })
