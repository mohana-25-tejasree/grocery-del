...
const AppPromoBanner = () => {
  return (
    <section className="max-w-7xl mx-auo px-4 sm:px-6 lg:px-8 py-20 my-14 bg-green-950 rounded-2xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 xl:px-10">
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              <button className="px-6 px-3 bg-white text-green-950 font-semibold rounded-xl hover:bg:orange-100">App Store</button>
              <button className="px-6 py-3 bg-white/20 transition-colors border border-white/20">Google Play</button>
            </div>
