  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <nav className="flex items-center gap-2 text-app-text-light">
        ...
        <button onClick={()=>navigate(-1)} className="mb-6 flex items-center gap-2 text-sm text-app-text-light hover:text-app-green transition-colors">
        ...
        <div className="bg-white/50 rounded-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <h1 className="text-xl md:text-3xl font-semibold text-app-green mb-3">{product.name}</h1>
              {product.rating >0 && (
              ...
              <div className="flex ietms-baseline gap-3 mb-5">
              ...
              <div className="flex items-center gap-3">
                ...
                }} disabled={product.stock === 0} className={`flex-1 py-3 font-semibold rounded-xl transition-colors flex-center gap-2 diasbled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] ${inCart ? "bg-app-cream text-app-green border border-app-green" : "bg-app-orange text-white hover:bg-app-orange-dark"}`}>
        ...
        {relatedProducts.length >0 && (
          <section className="mt-12 mb-44">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:gap-8">
