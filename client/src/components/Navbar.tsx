...
const Navbar = () => {
    const user : any  = {name:"mohana" , email: "mohana@example.com" , isAdmin: true}
  ...
  return (
    <nav className="bg-white stickytop-0 z-50 border-b border-app-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
            ...
            <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
                ...
                <form onSubmit={handleSearch} className="sm:flex flex-1 max-w-sm text-xs sm:text-sm">
                    <div className="relative w-full flex items-center">
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-orange-50 rounded-full border border-transparent ring-1 ring-app-orange/15 focus:outline-none focus:ring-app-orange/30"/>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        :(
                            <div className="flex-center gap-2">
                                <Link to ="/login" className="hiddden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-950 rounded-full hover:bg-green-950-light transition-colors">
                                <UserIcon size={16} />
                                </Link>
                                {userMenuOpen ? <XIcon onClick={()=>setUserMenuOpen(!userMenuOpen)} /> : <MenuIcon onClick={()=>setUserMenuOpen(!userMenuOpen)} />}
                            ...
                            <>
                                ...
                                <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                                    ...
                                    <div onClick={()=>setUserMenuOpen(false)}>
                                        ...
                                        {user  && (
                                            <div>
                                                <button onClick={handleLogout} className="flex items-center gap-3 px-3 py-3 text-sm text-app-error hover:bg-red-50 w-full transition-colors">
