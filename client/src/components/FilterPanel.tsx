...
const FilterPanel = ({categories, category, minPrice, maxPrice, updateFilter, clearFilters,hasFilters} : any) => {
  ...
  return (
    <div className="space-y-6">
        <div>
            <h3 className="text-sm font-semibold text-app-green m-3 ">Categories</h3>
        ...
        <div>
            ...
            <div className="flex items-center gap-2">
                ...
                <input type="number" placeholder="Max" value={minPrice} onChange={(e)=>updateFilter('minPrice', e.target.value)} className="w-full px-3 py-2 text-sm bg-white rounded-lg border not-focus:border-app-border" />
