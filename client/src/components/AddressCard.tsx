        ...
        <div className="flex gap-4">
            ...
            <div>
                <div className="flex items-center gap-2 mb-1">
                    <p className="text-s font-semibold text-app-green">{addr.label}</p>
                    {addr.isDefault && (
                        <span className="flex-center gap-1 px-.5 py-0.5 text-[10px] font-medium bg-app-green text-white rounded-full">
